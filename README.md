...
Note that most of these Principles of the Master Prompt are *not* 'rules,' as we commonly call them and understand them to be.  Specifically, there are (only) eight rules plus twelve recommendations and suggestions.
